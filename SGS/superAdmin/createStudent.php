...
if(isset($_POST['submit'])){
  ...
  $batch=$_POST['batch'];
    ...
    $query=mysqli_query($con1,"select * from students where regno ='$regno'");
    $ret=mysqli_fetch_array($query);
    if($ret > 0){

      $alertStyle ="alert alert-danger";
      $statusMsg="Student with the Register Number already exist!";
                                            ...
                                            <div class="row">
												...
												<!-- Log on to codeastro.com for more projects! -->
                                                    <label for="x_card_code" class="control-label mb-1">Student Name</label>
                                                        <input id="" name="studentname" type="text" class="form-control cc-cvc" value="" Required data-val="true" data-val-required="Please enter the security code" data-val-cc-cvc="Please enter a valid security code" placeholder="Enter Student Name">
                                                        </div>
                                                    </div>
                                                    <div>
