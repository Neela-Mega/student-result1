...
$query = mysqli_query($con1,"select * from students where regno='$_SESSION[editStudentId]'");
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Student Name</label>
                                                        <input id="" name="studentname" type="text" class="form-control cc-cvc" value="<?php echo $rowi['studentname'];?>" Required data-val="true" data-val-required="Please enter the security code" data-val-cc-cvc="Please enter a valid security code" placeholder="Enter Student name">
                                                        </div>
                                                    </div>
                                                    <div>
